...
export const MainLayout = ({ children }: { children: React.ReactNode }) => {
	...
	return (
		<div className="flex relative min-w-96">
			...
			<div className="w-full bg-slate-50 h-screen overflow-auto">
				{sectionName && (
					<header className="flex justify-between items-center p-5 border-b-2 border-gray-300 bg-white md:px-16">
						<CiMenuBurger
