    ...
    if (name === "receivedFee") {
      ...
      if (customerData) {
        ...
        if (totalAmount >= customerData.feeValue) {
          ...
          creditedBalance =
            totalAmount - invoicedInstallments * customerData.feeValue;
      ...
      if (customerData != null) {
        ...
        if (customerData.docId) {
          ...
          await updateDocument(
            ...
            {
              installmentsPaid:
                customerData.installmentsPaid + formData.invoicedInstallments,
    ...
    <div className="flex justify-evenly items-center">
      ...
      >
          ...
          {customerData && (
            <span className="text-sm self-center ml-2 text-green-600">
              ...
              {customerData.creditedBalance
                ? " $" +
                  formatNumber(customerData.creditedBalance).formattedValue
                : " No tiene abonado"}
            </span>
          )}
        </InputField>
        ...
        >
          {customerData && (
            <span className="text-sm self-center mt-2 ml-2 text-orange-300 flex items-center gap-2">
              <CgDanger />
              Valor de cuota:
              {" $" + formatNumber(customerData.feeValue).formattedValue ||
                " Sin informacion"}
            </span>
          )}
        </InputField>
        ...
        <div className="my-8 border-t pt-4">
          ...
          <div className="flex justify-between mb-4">
            <span className="text-gray-500">Nuevo saldo abonado:</span>
            <span className="font-semibold text-gray-900">
              $ {formatNumber(formData.creditedBalance).formattedValue}
            </span>
          </div>

          <div className="flex justify-between mb-4">
            <span className="text-gray-500">Cantidad de cuotas pagadas:</span>
            <span className="font-semibold text-gray-900">
      ...
      <div className="flex flex-col items-center justify-center gap-3">
        ...
        <BillingViewer
          invoiceData={{
            ...
            user: "JOSE",
            vehiclePlate: customerData?.vehiclePlate || "Sin informacion",
            receivedFee: formData.receivedFee,
            oldCreditedBalance: customerData?.creditedBalance || 0,
            totalAmount: formData.totalAmount,
            newCreditedBalance: formData.creditedBalance,
            invoicedInstallments: formData.invoicedInstallments,
            customerInstallmentsPaid: customerData?.installmentsPaid || 0,
            customerId: customerData?.docId || "",
          }}
        />
      </div>
